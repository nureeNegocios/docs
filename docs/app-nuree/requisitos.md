...
| <a id="rf-e5-14">RF-E5.14</a> | O sistema deve permitir ao admin definir uma regra de disponibilidade com vigência (início e fim), dias da semana, horários e periodicidade em semanas, da qual os slots finitos são materializados. | Admin | Alta | [RF-E5.1](#rf-e5-1) | Decisão de projeto | Criar a regra "quarta e quinta, a cada duas semanas, de 01/10 a 15/12" e ver publicados os slots dessas semanas, e só delas. |
| <a id="rf-e5-15">RF-E5.15</a> | O sistema deve permitir ao admin vincular cada regra de disponibilidade a um público — o programa inteiro ou um subconjunto das suas participações. | Admin | Alta | [RF-E5.14](#rf-e5-14), [RF-E1.3](#rf-e1-3) | Decisão de projeto | Duas regras no mesmo programa, com públicos distintos; cada participante só enxerga a grade da sua. |
| <a id="rf-e5-16">RF-E5.16</a> | O sistema deve permitir ao admin definir, em cada regra, a cota de sessões por pessoa dentro da vigência. | Admin | Alta | [RF-E5.14](#rf-e5-14) | Decisão de projeto | Regra de cota 3: a quarta tentativa da mesma pessoa é barrada. |
| <a id="rf-e5-17">RF-E5.17</a> | O sistema deve permitir ao admin definir, em cada regra, o intervalo mínimo entre duas sessões da mesma pessoa, sendo válido o intervalo nulo. | Admin | Alta | [RF-E5.14](#rf-e5-14) | Decisão de projeto | Com intervalo de duas semanas, os slots a menos de duas semanas da sessão já marcada somem da grade daquela pessoa; com intervalo nulo, dois dias seguidos são aceitos. |
| <a id="rf-e5-18">RF-E5.18</a> | Se o cliente tentar agendar um slot que viola a cota ou o intervalo mínimo da regra, então o sistema deve negar e dizer qual das duas barrou. | Cliente | Alta | [RF-E5.16](#rf-e5-16), [RF-E5.17](#rf-e5-17) | Decisão de projeto | A negativa distingue cota esgotada de intervalo mínimo não cumprido. |
| <a id="rf-e5-19">RF-E5.19</a> | O sistema deve permitir ao admin ajustar ocorrências específicas de uma regra — suprimir, mover de dia ou de horário e acrescentar uma ocorrência avulsa — sem alterar a regra nem as demais ocorrências. | Admin | Alta | [RF-E5.14](#rf-e5-14) | Decisão de projeto | Suprimir a quarta de uma semana e abrir a terça no lugar; as outras semanas seguem como estavam. |
| <a id="rf-e5-20">RF-E5.20</a> | O sistema deve permitir ao admin escolher, em cada regra, se compromissos de outras agendas no mesmo horário bloqueiam ou não o slot exibido ao cliente. | Admin | Média | [RF-E5.14](#rf-e5-14), [RF-E5.10](#rf-e5-10) | Decisão de projeto | Com a opção ligada, o horário ocupado some da grade; com ela desligada, o slot continua ofertado. |
| <a id="rf-e5-21">RF-E5.21</a> | O sistema deve exibir ao admin, em cada regra, o acompanhamento de cada pessoa do público: sessões agendadas, realizadas e quantas faltam para cumprir a cota. | Admin | Alta | [RF-E5.15](#rf-e5-15), [RF-E5.16](#rf-e5-16) | Decisão de projeto | Numa regra de cota 3, distinguir quem já marcou as três, quem marcou parte e quem não marcou nenhuma. |
| <a id="rf-e5-22">RF-E5.22</a> | O sistema deve calcular e exibir ao admin, a partir do público, da cota por pessoa, da periodicidade e do intervalo mínimo, quantos slots a regra precisa ofertar no mínimo e qual a folga ou o déficit da oferta configurada. | Admin | Alta | [RF-E5.21](#rf-e5-21) | Decisão de projeto | Dez pessoas com cota 3 exigem 30 slots; a regra que oferta 24 acusa déficit de 6, e a que oferta 36 acusa folga de 6. |

O vínculo entre a regra de disponibilidade e a etapa de jornada ([E7](#e7-montar-e-exibir-a-jornada-do-participante)) está previsto e **não entra no E5**: aqui a regra se prende ao programa e ao público, não à etapa.
